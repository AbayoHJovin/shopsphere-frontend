...
export default function ReturnRequestsPage() {
  ...
  useEffect(() => {
    fetchReturnRequests();
  }, [currentPage, statusFilter, customerTypeFilter, sortDirection]);
          ...
          <div className="space-y-4">
            ...
            {(statusFilter !== 'ALL' || customerTypeFilter !== 'ALL' || searchTerm) && (
              <div className="flex flex-wrap gap-2 p-3 bg-muted rounded-md">
                ...
                {customerTypeFilter !== 'ALL' && (
                  <Badge variant="secondary">Customer: {customerTypeFilter}</Badge>
                )}
                {searchTerm && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-2">
              ...
              <div className="min-w-[150px]">
                ...
                <Select value={customerTypeFilter} onValueChange={(value) => setCustomerTypeFilter(value as 'ALL' | 'REGISTERED' | 'GUEST')}>
                  <SelectTrigger>
              ...
              <div className="min-w-[150px]">
                ...
                <Select value={sortDirection} onValueChange={(value) => handleSortChange(value as 'ASC' | 'DESC')}>
                  <SelectTrigger>
          ...
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="text-lg font-medium">Loading return requests...</p>
              ...
              <div className="hidden md:block overflow-x-auto">
                ...
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="min-w-[120px]">Refund Amount</TableHead>
                    ...
                    <TableRow key={returnRequest.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-1">
                          ...
                          <span>{returnRequest.returnItems.length} item(s)</span>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="flex items-center gap-1">
                          ...
                          <span className="font-medium">
                            {formatCurrency(calculateTotalRefundAmount(returnRequest))}
                          </span>
                        </div>
                      </TableCell>
                      <TableCell>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <div>
                            <div className="text-sm">
                              {format(new Date(returnRequest.submittedAt), 'MMM dd, yyyy')}
                            </div>
                            <div className="text-xs text-muted-foreground">
                              {formatDistanceToNow(new Date(returnRequest.submittedAt), { addSuffix: true })}
                            </div>
                          </div>
                        </div>
                      </TableCell>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm">{returnRequest.customerName || 'Guest User'}</span>
                        </div>
                        
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-muted-foreground">Items:</span>
                          <span className="text-sm">{returnRequest.returnItems.length} item(s)</span>
                        </div>
